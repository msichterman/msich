...
export default function ContactForm() {
  ...
  const inputStyles =
    "m-0 block w-full min-w-0 flex-auto appearance-none rounded-md border border-neutral-900/10 bg-white px-3 py-[calc(0.5rem-1px)] shadow-md shadow-neutral-800/5 placeholder:text-neutral-400 focus:border-sky-500 focus:outline-none focus:ring-4 focus:ring-sky-500/10 dark:border-neutral-700 dark:bg-neutral-700/[0.15] dark:text-neutral-200 dark:placeholder:text-neutral-500 dark:focus:border-sky-400 dark:focus:ring-sky-400/10 sm:text-sm";
  const errorInputStyles =
    "m-0 block w-full min-w-0 flex-auto appearance-none rounded-md border bg-white px-3 py-[calc(0.5rem-1px)] shadow-md shadow-neutral-800/5 placeholder:text-neutral-400 focus:outline-none focus:ring-4 focus:ring-sky-500/10 dark:bg-neutral-700/[0.15] dark:text-neutral-200 dark:placeholder:text-neutral-500 dark:focus:ring-sky-400/10 sm:text-sm border-red-500";
  const labelStyles =
          ...
          >
            ...
            <div className="flex justify-end sm:col-span-2">
              ...
              <Button
                type="submit"
                disabled={isSubmitting}
                className={clsx(contact.isPending && "animate-pulse")}
              >
                Submit
              </Button>
            </div>
